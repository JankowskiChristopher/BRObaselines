...
from jaxrl.agents.dac.actor import update as update_actor
from jaxrl.agents.dac.actor import update_optimistic as update_actor_optimistic
from jaxrl.agents.dac.actor import update_optimistic_quantile as update_actor_optimistic_quantile
from jaxrl.agents.dac.actor import update_quantile as update_actor_quantile
from jaxrl.agents.dac.actor import update_categorical as update_actor_categorical
from jaxrl.agents.dac.critic import target_update, validate_batch, critic_activations
from jaxrl.agents.dac.critic import update as update_critic
from jaxrl.agents.dac.critic import update_quantile as update_critic_quantile
from jaxrl.agents.dac.critic import update_categorical as update_critic_categorical
...
class DACLearner(object):
    def __init__(
        ...
        def _init_models(seed):
            ...
            actor_o_def = policies.DecoupledPolicy(self.actor_size, action_dim, activations=nn.relu, model_version=self.actor_type, depth=self.actor_depth)
            if self.actor_type == 1:
